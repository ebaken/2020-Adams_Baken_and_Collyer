...
Note that under the null hypothesis, $E(\lambda)=0$, a no phylogenetic signal is expected under this condition [@Freckleton_et_al2002]. 
...
Finally, for comparison we characterized the strength of phylogenetic signal in each dataset using a standardized effect size [$Z_K$: sensu @AdamsCollyer2016; @AdamsCollyer2019b] based on $Kappa$. 
