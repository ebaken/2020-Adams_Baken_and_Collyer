...
\caption{Response of Blomberg's *K* to increasing strength of Brownian motion. ~~Gray line signifies the 1:1 line where the input value matches the estimate \(\hat K\).~~ At each input level, the dark black line represents the empirically derived expected value (mean) of
