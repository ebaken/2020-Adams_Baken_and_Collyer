...
where $K_{obs}$ is the observed phylogenetic signal, and $\hat\mu_K$ and $\hat\sigma_K$ are the mean and standard deviation of the empirical sampling distribution of *K* obtained via permutation. The empirical sampling distribution of *K* is first transformed via a Box-Cox transformation to better adhere to the assumption of normality. 
...
\caption{Response of effect sizes \(Z_{\lambda}\) and \(Z_K\) to increasing strength of Brownian motion.{}}
\end{figure}
