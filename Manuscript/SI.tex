...
\includegraphics[width=0.95\linewidth]{Figs/fig.S1}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S2}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S3}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S4}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S5}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S6}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S7}
...
collapsed nodes, following the procedures of (Molina-Venegas \&
Rodríguez, 2017). Results from simulations on phylogenies containing
polytomies mirrored those found on fully resolved trees. For
\(\hat{\lambda}\), the mean value increased with increasing input
signal, but was negatively biased, and was less than the input value
across most of its range (Fig. S8: black line). Additionally, the
precision of \(\hat{\lambda}\) varied with differing input levels, with
the greatest variation found at intermediate values of \(\lambda\) (Fig.
S8 red line). Finally, the distribution of \(\hat{\lambda}\) was not
normal, and became more skewed at more extreme values of \(\lambda\)
(Fig. S8 blue line). \hfill\break
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S8}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S9}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S10}
...
phylogenetic ANOVA, mirroring prior findings of (Adams \& Collyer,
2018). These results generally confirmed earlier findings of (Revell,
2010) for phylogenetic regression, and extend them to the case of
phylogenetic ANOVA.

\includegraphics[width=0.95\linewidth]{Figs/fig.S11}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S12}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S13}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S14}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S15}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S16}
...
\includegraphics[width=0.95\linewidth]{Figs/fig.S17}
...
an estimate of the type I error or false discovery rate. Specifically,
...
S21). Likewise, levels of false discovery were also low, and were at or
below the nominal 5\% level (Fig. S21). Both results demonstrate that
comparisons of the strength of phylogenetic signal using
\(\hat{Z}_{12}\) do not display high levels of false positives, and are
thus appropriate for comparing the degree of phylogenetic signal across
traits.

\includegraphics[width=6.67in,height=0.5\textheight]{Figs/fig.S21}

\textbf{Figure S21}. Type I error rates and false discovery rates for
\(\hat{Z}_{12}\). Type I error is found on the far-left of the plot
(\(\lambda = 0\)). Each colored line represents the curve for a given
level of tree size.
