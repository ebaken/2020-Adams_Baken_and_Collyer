...
### Arguments for pectinate tree analyses

sim.args <- list(treesize = treesizes[1], tree.type = "pect",
...
sim.sets_32 <- read.csv("Data_Analyses/updated_simulations/results/pect.32.50.sim.0.poly.mean.type.csv")
sim.sets_64 <- read.csv("Data_Analyses/updated_simulations/results/pect.64.50.sim.0.poly.mean.type.csv")
sim.sets_128 <- read.csv("Data_Analyses/updated_simulations/results/pect.128.50.sim.0.poly.mean.type.csv")
sim.sets_256 <- read.csv("Data_Analyses/updated_simulations/results/pect.256.50.sim.0.poly.mean.type.csv")
sim.sets_512 <- read.csv("Data_Analyses/updated_simulations/results/pect.512.50.sim.0.poly.mean.type.csv")
sim.sets_1024 <- read.csv("Data_Analyses/updated_simulations/results/pect.1024.50.sim.0.poly.mean.type.csv")

sim.sets <- list(sim.sets_32, sim.sets_64, sim.sets_128, sim.sets_256, sim.sets_512, sim.sets_1024)
names(sim.sets) <- treesizes

png(filename = "Manuscript/fig.S1.png",width = 800, height = 1000, units = "px", pointsize = 18)
par(mfrow = c(3, 2), 
    mar = c(5,5,1,2))
...
### plot kappas
png(filename = "Manuscript/fig.S2.png",width = 800, 
...
png(filename = "Manuscript/fig.S3.png",width = 800, 
    height = 1000, units = "px", pointsize = 18)
...
<<<<<<< HEAD
                mean.col = 1, mean.lwd = 3, ylim = c(-3, 35))
=======
                mean.col = 1, mean.lwd = 3, ylim = c(-3, 50))
>>>>>>> 4a60e041cdc823625c5b1cef2aea7c11e094e8a2
