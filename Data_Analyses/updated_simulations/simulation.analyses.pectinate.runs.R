...
png(filename = "Manuscript/SupportingInfo_Figs/fig.1.pect.png",width = 800, height = 1000, units = "px", pointsize = 18)
par(mfrow = c(3, 2), 
    mar = c(5,5,1,2))
...
### plot kappas
png(filename = "Manuscript/SupportingInfo_Figs/fig.2.pect.png",width = 800, 
...
png(filename = "Manuscript/SupportingInfo_Figs/fig.3.pect.png",width = 800, 
    height = 1000, units = "px", pointsize = 18)
