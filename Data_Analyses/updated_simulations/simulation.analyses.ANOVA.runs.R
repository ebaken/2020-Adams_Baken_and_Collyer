...
sim.sets_32 <- read.csv("Data_Analyses/updated_simulations/results/pb.32.50.sim.0.poly.anova.type.csv")
sim.sets_64 <- read.csv("Data_Analyses/updated_simulations/results/pb.64.50.sim.0.poly.anova.type.csv")
sim.sets_128 <- read.csv("Data_Analyses/updated_simulations/results/pb.128.50.sim.0.poly.anova.type.csv")
sim.sets_256 <- read.csv("Data_Analyses/updated_simulations/results/pb.256.50.sim.0.poly.anova.type.csv")
sim.sets_512 <- read.csv("Data_Analyses/updated_simulations/results/pb.512.50.sim.0.poly.anova.type.csv")
sim.sets_1024 <- read.csv("Data_Analyses/updated_simulations/results/pb.1024.50.sim.0.poly.anova.type.csv")
sim.sets <- list(sim.sets_32, sim.sets_64, sim.sets_128, sim.sets_256, sim.sets_512, sim.sets_1024)
names(sim.sets) <- treesizes

png(filename = "Manuscript/SupportingInfo_Figs/fig.1.ANOVA.png",width = 800, height = 1000, units = "px", pointsize = 18)
par(mfrow = c(3, 2), 
    mar = c(5,5,1,2))
...
png(filename = "Manuscript/SupportingInfo_Figs/fig.2.ANOVA.png",width = 800, 
...
png(filename = "Manuscript/SupportingInfo_Figs/fig.3.ANOVA.png",width = 800, 
    height = 1000, units = "px", pointsize = 18)
...
png(filename = "Manuscript/SupportingInfo_Figs/regression.precision.ANOVA.png",width = 800, 
    height = 1000, units = "px", pointsize = 18)
